...
namespace ArmyTechTask.Controllers
{
    public class BrancheController : Controller
    {
        ...
        public BrancheController(ArmyTechTaskContext context)
        {
            _context = context;
        }
        ...
        {
            var armyTechTaskContext = _context.Branches.Include(b => b.City);
        ...
        public async Task<IActionResult> Create([Bind("Id,BranchName,CityId")] Branch branch)
        {
            ...
            ViewData["CityId"] = new SelectList(_context.Cities, "Id", "Id", branch.CityId);
            return View(branch);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ArmyTechTaskContext.Branches'  is null.");
            }
            var branch = await _context.Branches.FindAsync(id);
            if (branch != null)
            {
